...
class BottleneckTransform(nn.Module):
    ...
    def __init__(self, w_in, w_out, stride, w_b, num_gs):
        ...
        (s1, s3) = (stride, 1) if False else (1, stride)
...
class ResNet(nn.Module):
    ...
    def _construct(self):
        ...
        self.head = GlobalHead(2048, nc=512)
    ...
    def complexity(cx):
        ...
        if "cifar" in cfg.TRAIN.DATASET:
            ...
            cx = ResHead.complexity(cx, 2048, nc=81313)
        return cx